Release 2.2.2 (September 28 2026) -- compared to 2.2.1
--------------------------------------------------------
...
- *fix*: make the transform cache thread-safe [#323](https://github.com/AcademySoftwareFoundation/rawtoaces/pull/323)
