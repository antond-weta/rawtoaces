...
template bool inverse<double>(
    const std::vector<std::vector<double>> &,
    std::vector<std::vector<double>> & );

template std::vector<std::vector<float>>
transposed( const std::vector<std::vector<float>> & );

template std::vector<std::vector<double>> product(
    const std::vector<std::vector<double>> &,
    const std::vector<std::vector<double>> & );

template std::vector<double> product(
